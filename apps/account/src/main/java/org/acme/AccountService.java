...
public class AccountService {
    ...
    private final CopyOnWriteArrayList<DTUPayUser> customers = new CopyOnWriteArrayList<DTUPayUser>();
    private final CopyOnWriteArrayList<DTUPayUser> merchants = new CopyOnWriteArrayList<DTUPayUser>();
